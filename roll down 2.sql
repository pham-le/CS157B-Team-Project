...
SELECT t.day_number_in_month, t.week_number_in_year, p.subcategory, s.store_street_address, s.city, sum(sf.unit_sales) total_unit_sold, sum(sf.customer_count) customer_count,
...
group by s.store_street_address, p.subcategory, t.day_number_in_month;
