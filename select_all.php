...
/*
	...
	//$selectall = "SELECT time_key, product_key FROM sales_fact";

	$result = $conn->query($selectall);

	// `Sales Fact` (`time_key`, `product_key`, `promotion_key`, `store_key`, `dollar_sales`, `unit_sales`, `dollar_cost`, `customer_count`)
